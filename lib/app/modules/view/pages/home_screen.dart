        ...
        Obx(
          () {
            ...
            return ListView.builder(
              shrinkWrap: true,
              itemCount: categoryController.categoryelement != null
                  ? categoryController.categoryelement!.length
                  : 1,
              physics: const BouncingScrollPhysics(),
              ...
              itemBuilder: (context, index) => CategoryWidget(
                  categoryElement: categoryController.categoryelement != null
                      ? categoryController.categoryelement![index]
                      : null),
