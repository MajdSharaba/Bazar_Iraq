...
class CreateProductPageV2 extends StatelessWidget {
 ...
 final List<CategoryElement>? subCategoryList;
  ...
  Widget build(BuildContext context) {
    List<CategoryElement>? categoryList=subCategoryList.isNull ? categoryController.categoryelement:subCategoryList;
    return Scaffold(
                  ...
                  return AnimationConfiguration.staggeredGrid(
                    ...
                    child:  ScaleAnimation(
                      child: FadeInAnimation(
                        child: CategoryCardForCreateProduct(categoryElement: categoryList[index],),
                      ),
                    ),
                  );
                },
